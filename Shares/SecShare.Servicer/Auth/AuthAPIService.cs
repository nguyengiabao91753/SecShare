...
using SecShare.Servicer.Security;
...
public class AuthAPIService : IAuthAPIService
{
    ...
    public AuthAPIService(IdentityApplicationDbContext db, UserManager<ApplicationUser> userManager, IJwtTokenGenerator jwtTokenGenerator)
    {
        _db = db;
